...
const Login = () => {
  ...
  return (
    <div className='mx-5'>
      ...
      <div>
        <Link to="/forgotPassword" className='text-xs font-extrabold text-iconClr  text-right'>Forgot your password?</Link>
      </div>

      <PrimaryButton buttonLabel="Sign In" btnClass="w-full mt-6 mb-6 h-10 text-xs"/>

      <div className='text-xs font-extrabold'>New to BC.GAME?<Link to="/SignUp"  className='ml-2 text-primaryClr'>Create account</Link></div>
    </div>
  )
}
